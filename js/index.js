...
const setEvents = () => {
  ...
  window.onscroll = function () {
    if (document.documentElement.scrollTop <= 1) {
      ...
      logoImg.src =
        "https://www.catonetworks.com/wp-content/uploads/2021/10/white.svg";
      topNavB.className =
        "d-flex justify-content-end navTranstion fixed-top mt-4  navtrans ";
      ...
      topNavB.className =
        "d-flex justify-content-between navTranstion fixed-top navlight  ";
